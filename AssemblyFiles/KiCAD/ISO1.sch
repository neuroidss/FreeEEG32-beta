...
AR Path="/637B2637/5CDC4527" Ref="U?"  Part="1" 
AR Path="/6385C8DD/5CDC4527" Ref="U?"  Part="1" 
F 0 "U14" H 3400 3547 60  0000 C CNN
...
F 4 "" H 3400 2950 50  0001 C CNN "MNP"
	1    3400 2950
	1    0    0    -1  
$EndComp
...
U 1 1 75BAB1CD
P 2200 2700
AR Path="/5CDBF57D/75BAB1CD" Ref="C?"  Part="1" 
AR Path="/5CE92451/75BAB1CD" Ref="C?"  Part="1" 
AR Path="/5CE92453/75BAB1CD" Ref="C?"  Part="1" 
AR Path="/5CE92455/75BAB1CD" Ref="C?"  Part="1" 
AR Path="/75BAB1CD" Ref="C?"  Part="1" 
AR Path="/5CDACD1E/75BAB1CD" Ref="C?"  Part="1" 
AR Path="/5CDCD748/75BAB1CD" Ref="C?"  Part="1" 
AR Path="/5CE35379/75BAB1CD" Ref="C116"  Part="1" 
AR Path="/5CDD240A/75BAB1CD" Ref="C118"  Part="1" 
AR Path="/5CDD240D/75BAB1CD" Ref="C120"  Part="1" 
AR Path="/637B2637/75BAB1CD" Ref="C?"  Part="1" 
AR Path="/6385C8DD/75BAB1CD" Ref="C?"  Part="1" 
F 0 "C116" H 2292 2746 50  0000 L CNN
F 1 "100n" H 2292 2655 50  0000 L CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 2200 2700 50  0001 C CNN
F 3 "~" H 2200 2700 50  0001 C CNN
F 4 "" H 2200 2700 50  0001 C CNN "MNP"
	1    2200 2700
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
AR Path="/637B2637/5CDC53E9" Ref="J?"  Part="1" 
AR Path="/6385C8DD/5CDC53E9" Ref="J?"  Part="1" 
F 0 "J39" H 2700 1667 50  0000 C CNN
F 1 "Conn_02x04_Odd_Even" H 2700 1576 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_2x04_P2.54mm_Vertical" H 2650 1350 50  0001 C CNN
...
U 1 1 75BAB1D1
P 4550 1300
AR Path="/5CE35379/75BAB1D1" Ref="J40"  Part="1" 
AR Path="/5CDD240A/75BAB1D1" Ref="J42"  Part="1" 
AR Path="/5CDD240D/75BAB1D1" Ref="J44"  Part="1" 
AR Path="/637B2637/75BAB1D1" Ref="J?"  Part="1" 
AR Path="/6385C8DD/75BAB1D1" Ref="J?"  Part="1" 
F 0 "J40" H 4600 1617 50  0000 C CNN
F 1 "Conn_02x04_Odd_Even" H 4600 1526 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_2x04_P2.54mm_Vertical" H 4550 1300 50  0001 C CNN
...
U 1 1 75BAB1D3
P 4750 2650
AR Path="/5CDBF57D/75BAB1D3" Ref="C?"  Part="1" 
AR Path="/5CE92451/75BAB1D3" Ref="C?"  Part="1" 
AR Path="/5CE92453/75BAB1D3" Ref="C?"  Part="1" 
AR Path="/5CE92455/75BAB1D3" Ref="C?"  Part="1" 
AR Path="/75BAB1D3" Ref="C?"  Part="1" 
AR Path="/5CDACD1E/75BAB1D3" Ref="C?"  Part="1" 
AR Path="/5CDCD748/75BAB1D3" Ref="C?"  Part="1" 
AR Path="/5CE35379/75BAB1D3" Ref="C117"  Part="1" 
AR Path="/5CDD240A/75BAB1D3" Ref="C119"  Part="1" 
AR Path="/5CDD240D/75BAB1D3" Ref="C121"  Part="1" 
AR Path="/637B2637/75BAB1D3" Ref="C?"  Part="1" 
AR Path="/6385C8DD/75BAB1D3" Ref="C?"  Part="1" 
F 0 "C117" H 4842 2696 50  0000 L CNN
F 1 "100n" H 4842 2605 50  0000 L CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 4750 2650 50  0001 C CNN
F 3 "~" H 4750 2650 50  0001 C CNN
F 4 "" H 4750 2650 50  0001 C CNN "MNP"
	1    4750 2650
	0    -1   -1   0   
$EndComp
Wire Wire Line
